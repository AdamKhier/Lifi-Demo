...
led_to_binary = {'LED_ON': '1', 'LED_OFF': '0'}
...
# Function to translate LED_ON or LED_OFF to binary
def led_to_binary_translator(led_states):
    binary_output = ''.join(led_to_binary[state] for state in led_states.split())
...
led_output = input("What text would you like to translate: ")

binary_input = led_to_binary_translator(led_output)
text_output = binary_to_text_translator(binary_input)
print("LED states to Text:", text_output)
